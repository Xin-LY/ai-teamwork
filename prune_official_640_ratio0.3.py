...
# ===================== 主流程：640 输入尺寸，剪枝比例 0.3 =====================

BASE_DIR = r"D:\yolo_industrial_prune\prune_exp"

# 640 baseline 权重
ORIG_WEIGHT = os.path.join(BASE_DIR, "base_weights", "yolov8n_640_baseline.pt")
...
def main():
    ...
    SAVE_DIR = os.path.join(BASE_DIR, "official_prune_640_ratio0.3")
